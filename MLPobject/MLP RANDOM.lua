...
brain:load("RANDOM TRAINING")             -- carrega a rede treinada
...
for i = 1,interactions do
    value = {0.39215686917305 + randomFloat(-error,error),0.11372549086809 + randomFloat(-error,error),0.11372549086809 + randomFloat(-error,error),
            (1 - error) + randomFloat(-error,error),0.11372549086809 + randomFloat(-error,error)}
...
print('green',"acurracy rate:",(((correct/interactions)*100).."%")) ; incorrect = 0 ; correct = incorrect
